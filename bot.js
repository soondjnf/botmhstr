...
┏━⇝『 أدارة 』⇜━┓
┃
┣► ^clear <number> ░ لمسح الرسال و العدد يعني اكتب الكوماند و اكتب كم رساله تريد مسحها
┃
┣► welcome للترحيب و للمغادرة اعمل شات اسمه
┃
┣► ^color <number> ░ يصنع كم لون تريد مثال اذا كتبت الكوماند و ١٠٠ راح يصنعلك ١٠٠ لون مختلف
┃
┣► ^bc <message> ░ لأرسال رساله للكل الذدين فل سيرفر

┏━⇝『 عامة 』⇜━┓
┃
┣► ^help ░ مساعده يطلعلك كل اوامر البوت
┃
┣► ^invite ░لأرسال دعوه البوت الى سيرفرك
┃
┣► ^server ░ معلومات السيرفر
┃
┣► ^avatar ░ يشوفك الأفتار حقك

┏━⇝『 العاب 』⇜━┓
┃
┣► ^راح يعطيك عقاب ولازم تسويه اذا ماتقدر تسويه اكتب الأمر مرة ثانيه وراح يجيك عقاب ثاني ░ عقاب
┃
┣► ^يعني معروفه العبه محتاج اشرح ░ لو خيروك
┃
┣► ^راح يعطيك حكمه اذا ماتقدر اتسوي الشي الي طلبه منك اكتب الأمر مرة ثانيه وراح يعطيك شي ثاني ░ حكم

==================================================================

Server support: https://discord.gg/UkDVKD6
...
if(message.content.startsWith(prefix + 'color')) {
    if(!args) return message.channel.send('`يرجي اختيار كم لون `');
             if (!message.member.hasPermission('ADMINISTRATOR')) return message.channel.sendMessage('`**⚠ | `[ADMINISTRATOR]` لا يوجد لديك صلاحية**'); 
             message.channel.send("**✅ | تم صنع الالوان**");
            ...
            message.guild.createRole({name:x,
             ...
             client.on('message', message => {
                if(message.content === prefix + "invite") {
                    ...
                    embed.setTitle("**:arrow_right: Invite SkelBot!**")
                    .setURL("https://discordapp.com/api/oauth2/authorize?client_id=462966424235802625&permissions=8&scope=bot");
...
client.on('message', msg => {
  ...
  let args = msg.content.split(" ").slice(1);
    ...
    if(command === "clear") {
        const emojis = client.emojis.find("name", "wastebasket");
    let textxt = args.slice(0).join("");
    if(msg.member.hasPermission("MANAGE_MESSAGES")) {
    if (textxt == "") {
        msg.delete().then;
    msg.channel.send("***```ضع كم رساله تريد مسحها```***").then(m => m.delete(3000));
} else {
    msg.delete().then;
    msg.delete().then;
...
'*** اتصل على امك و قول لها انك تحبها :heart:. ***',
   ...
   '*** قول نكتة اذا و لازم احد الاعبين يضحك اذا محد ضحك يعطونك ميوت الى ان يجي دورك مرة ثانية.***',
   '*** سامحتك خلاص مافيه عقاب لك :slight_smile:. ***',
   '*** اذهب ال�� واحد ماتعرفه وقل له انا كيوت وابي بوسه.***',
   '*** تتصل على الوالده  و تقول لها خطفت شخص. ***',
   '*** روح اكل ملح + ليمون اذا مافيه اكل اي شيء من اختيار الي معك.  ***'
]
 client.on('message', message => {
 ...
 if (message.content.startsWith(prefix + 'حكم')) {
  ...
  .setTitle("لعبة حكم ..")
  .setColor('RANDOM')
  .setDescription(`${Himo_04_[Math.floor(Math.random() * Himo_04_.length)]}`)
